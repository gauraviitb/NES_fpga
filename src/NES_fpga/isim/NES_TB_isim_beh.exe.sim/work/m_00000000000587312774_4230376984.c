...
static int ng23[] = {1541, 0};
static int ng24[] = {1542, 0};
static int ng25[] = {1543, 0};
static unsigned int ng26[] = {0U, 4294967295U};
...
{
	static char *pe[] = {(void *)Initial_33_0,(void *)Always_60_1,(void *)Cont_72_2};
